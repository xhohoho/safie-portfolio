...
export default function Portfolio() {
  ...
  return (
    <div className="relative min-h-screen bg-[#020617] text-slate-300 font-sans selection:bg-cyan-500/30 overflow-x-hidden">
      ...
      >
        <Image src="/gears.gif" alt="Industrial Gears" fill className="object-contain" />
      </motion.div>
      ...
      <div className="relative z-10">
            ...
            <div className="w-[280px] h-[280px] md:w-[450px] md:h-[450px] relative">
              ...
              <div className="absolute -bottom-4 -right-2 md:-bottom-6 md:-right-6 bg-slate-900 p-3 md:p-5 border border-slate-800 shadow-2xl z-20">
                <div className="flex items-center gap-2 md:gap-3 mb-1">
                  ...
                  <p className="text-[8px] md:text-[10px] font-mono text-cyan-500 uppercase tracking-widest font-bold">Research Active</p>
                </div>
                <p className="text-[10px] md:text-sm font-bold text-white uppercase tracking-tight">MRB AI Chatbot v1.0</p>
              </div>
            </div>
          </motion.div>
        </section>
        ...
        <footer className="py-20 text-center">
          <div className="flex justify-center gap-10 mb-8 font-mono text-[10px] uppercase tracking-widest">
